...
<center><a href="http://alkabirtravels.com"><img src="http://alkabirtravels.com/frontend/img/piclogo.jpg" style="height: 50px;" alt="img"></a>
</center>
</td>
...
<h3 style="font-weight: normal; font-size: 16px; text-transform: capitalize;">Visa Request Mail</h3>

<span style="display: block; padding-bottom: 10px " class="wrap_textbox">Visa Title : {{$data['title']}}  </span>
...
<span style="display: block; padding-bottom: 10px " class="wrap_textbox">Message: {{$data['message']}}</span>
