						...
						<tr style="">
							<td class="text" style="font-family: 'Poppins', sans-serif; color:#383838; font-weight:400; line-height:26px; font-size: 14px; text-decoration:none; padding:66px 20px 68px; background: #dbffd2">
								<div class="rocket-txt">
									...
									<h3 style="font-weight: normal; font-size: 16px; text-transform: capitalize;">Get In Touch Email</h3>

									<span style="display: block; padding-bottom: 10px " class="wrap_textbox">Name : {{$data['first_name']}} </span>
									...
									<span style="display: block; padding-bottom: 10px " class="wrap_textbox">Address : {{$data['address']}} </span>
