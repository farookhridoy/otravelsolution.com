<template>
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('generalpages')">
        <icon name="cheveron-right" class="w-4 h-4 mr-2" :class="isUrl('generalpages') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
